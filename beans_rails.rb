...
['.gitignore', 'Gemfile', 'config/database.yml', 'config/environments/development.rb', 'config/environments/production.rb', 'config/environments/test.rb', 'config/preinitializer.rb'].each { |file| template_file(file) }
